  ...
  return (
    <section className="relative w-full bg-black text-white">
      ...
      <section className="relative bg-black py-12 text-white">
        ...
        {/* ✅ Video container */}
        <div className="relative w-[60%] h-[50%] mx-auto rounded-2xl overflow-hidden shadow-xl mt-15 ">
          <video
            src={Services}
            alt="Our Story"
            className={`w-full h-full object-cover brightness-90 transition-opacity duration-1000 pointer-events-none ${loaded ? "opacity-100" : "opacity-0"
              }`}
            autoPlay
            muted
            loop
